...
lli.1= as.numeric(args[19]) # short-term interaction parameter: acquiring 1 while having 2 (this value can)
cat(",lli.1=",lli.1)
lli.2= as.numeric(args[20]) # short-term interaction parameter: acquiring 1 while having 2 (this value can)
cat(",lli.2=",lli.2)
